...
class MAG extends Application {
    ...
    static String lastParentAdvancement
    ...
    void start(Stage primaryStage) throws Exception {
        ...
        lastParentAdvancement = settings.getOrDefault("Last adv. parent", "")
        ...
        checkFiles.setOnAction(new EventHandler<ActionEvent>() {
            ...
            void handle(ActionEvent event) {
                ...
                if (dir != null) {
                    lastResourceFolder = dir.getParentFile().getAbsolutePath()
    ...
    void stop() throws Exception {
        ...
        settings.put("Last adv. parent", lastParentAdvancement)
        settings.save()
    }
}
