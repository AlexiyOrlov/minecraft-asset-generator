...
import alexiy.minecraft.asset.generator.AdvancementTrigger;
...
public class CreateAdvancement implements EventHandler<ActionEvent> {
    ...
    public void handle(ActionEvent event) {
        ...
        final Vbox2 mainBox = new Vbox2();
        Vbox2 secondaryBox = new Vbox2();
        ...
        addCriterion.setOnAction(et -> {
            ...
            advancementTriggerChoiceBox.setOnAction(event1 -> {
                ...
                switch (trigger) {
                    case INVENTORY_CHANGED:
                        ...
                        secondaryBox.getChildren().addAll(new Hbox2(items, flowPane, addItem));
                    ...
                    case KILLED_ENTITY:
                        ...
                        entity.setTooltip(new Tooltip("Entity identifier"));
                        entity.setMinWidth(300);
                        Hbox2 container = new Hbox2(entityLabel, entity);
                        secondaryBox.getChildren().addAll(container);
            ...
            secondaryBox.getChildren().addAll(criterion, advancementTriggerChoiceBox, label);
            mag.getTabPane().requestLayout();
        });
        ...
        displayItem.setMinWidth(300);
        Button generate = new Button("Generate file");
        generate.setOnAction(evnt -> {
        ...
        mainBox.getChildren().addAll(identifier, parent, new Vbox2(new Hbox2(label, title), new Hbox2(desclable, description), new Hbox2(itemLabel, displayItem)), new Hbox2(addCriterion), new Hbox2(rewards, experience, exp, addReward), rewardsContainer, new ScrollPane(secondaryBox), generate);
        Tab tab = new Tab(MAG.getLastModId() + identifier.getText(), mainBox);
